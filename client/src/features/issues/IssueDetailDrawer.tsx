            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-[18px] p-[22px] rounded-2xl bg-slate-50 border border-slate-200/90 shadow-2xs">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="h-[42px] bg-white text-slate-800 text-xs font-medium rounded-xl px-[14px] border border-slate-200 focus:border-indigo-500 outline-none cursor-pointer shadow-2xs"
                />
              </div>
            </div>
              ...
              {isEditingDesc ? (
                <div className="flex flex-col gap-2">
                  <textarea
                    ...
                    rows={4}
                    autoFocus
                    className="w-full bg-white text-slate-800 border border-indigo-500 rounded-xl p-[14px] text-xs resize-y outline-none leading-relaxed shadow-xs"
                ...
                <div
                  onClick={() => setIsEditingDesc(true)}
                  className="p-[14px] rounded-xl bg-slate-50 border border-slate-200 text-xs text-slate-700 leading-relaxed cursor-pointer hover:border-slate-300 transition-colors min-h-[70px] whitespace-pre-wrap"
                >
                  {issue.description || (
