  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col gap-8 pb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-bg-surface p-5 rounded-xl border border-border-subtle flex flex-col gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          {isProjectsLoading ? (
            ...
            <div className="flex flex-col gap-4">
              {projects.map((proj) => (
                <div
                  key={proj.id}
                  className="bg-bg-surface p-6 rounded-xl border border-border-subtle hover:border-border-medium transition-colors flex flex-col gap-3"
                >
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between pt-3 mt-1 border-t border-border-subtle/60">
        ...
        <div className="lg:col-span-5 flex flex-col gap-4">
          ...
          <div className="bg-bg-surface rounded-xl border border-border-subtle p-3 flex flex-col gap-2.5">
            {isIssuesLoading ? (
              ...
              sortedRecent.map((iss) => (
                <Link
                  ...
                  className="p-3 rounded-lg bg-slate-900/60 hover:bg-slate-800/80 border border-border-subtle/80 hover:border-border-medium transition-all flex items-center justify-between gap-3"
                >
